...
class AcctController extends Component {
  ...
  render() {
    ...
    //if open is pressed pull  up account component with the details of what has
    //  been entered into the name and balance and become part of the array
    // });
...
. */}
        ...
        <div>
          {/* <AcctMultiple id="Multiple" account={myAccount} balance={this.state.accBalance}/> */}
        </div>
